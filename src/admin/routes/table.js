...
router.patch('/disableTableType', authMiddleware.verifyToken, authorizeMiddleware.authorizePage('admin'), tableController.disableTableType);
router.post('/addTable', authMiddleware.verifyToken, authorizeMiddleware.authorizePage('admin'), tableController.addTable);
router.patch('/disableTable', authMiddleware.verifyToken, authorizeMiddleware.authorizePage('admin'), tableController.disableTable);
